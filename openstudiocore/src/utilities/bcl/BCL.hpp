...
namespace openstudio{
  ...
  class COREUTILITIES_API BCLFacet {
  public:
  ...
  class COREUTILITIES_API BCLTaxonomyTerm {
  public:
  ...
  class COREUTILITIES_API BCLFile {
  public:
  ...
  class COREUTILITIES_API BCLProvenance {
  public:
  ...
  class COREUTILITIES_API BCLCost {
  public:
  ...
  class COREUTILITIES_API BCLMetaSearchResult {
  public:
  ...
  class COREUTILITIES_API BCLSearchResult {
  public:
  ...
  class COREUTILITIES_API BCL : public QObject {
  ...
  COREUTILITIES_API boost::optional<BCLComponent> getComponent(const std::string& uid,
   ...
   *  LocalBCL (existing or just downloaded). */
  COREUTILITIES_API boost::optional<BCLMeasure> getMeasure(const std::string& uid,
                                                       const std::string& versionId = "");
