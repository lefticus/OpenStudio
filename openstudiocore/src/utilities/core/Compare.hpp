...
inline COREUTILITIES_API bool istringEqual(const std::string& x, const std::string& y){
  return boost::iequals(x, y);
};

/** Compare two strings without regard to case. */
inline COREUTILITIES_API bool istringLess(const std::string& x, const std::string& y) {
...
struct COREUTILITIES_API IstringCompare{
...
COREUTILITIES_API std::ostream& operator<<(std::ostream& os,const VersionString& version);

typedef boost::optional<VersionString> OptionalVersionString;

// sorts BCLComponents by name
struct COREUTILITIES_API BCLComponentNameLess {
  bool operator()(const BCLComponent& a, const BCLComponent& b) const;
};

// sorts BCLComponents by name
struct COREUTILITIES_API BCLComponentNameGreater {
  bool operator()(const BCLComponent& a, const BCLComponent& b) const;
};
