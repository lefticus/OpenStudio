...
namespace openstudio{
  ...
  COREUTILITIES_API void logFree(LogLevel level, const std::string& channel, const std::string& message);

  /** Singleton logger class.  Singleton Logger object maintains logging state throughout
   *   program execution.
   */
  class COREUTILITIES_API LoggerSingleton {
  ...
  UTILITIES_TEMPLATE_EXT template class COREUTILITIES_API openstudio::Singleton<LoggerSingleton>;
