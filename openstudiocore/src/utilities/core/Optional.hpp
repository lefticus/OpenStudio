...
namespace openstudio {
  ...
  COREUTILITIES_API std::ostream& operator<<(std::ostream& os, const boost::optional<double>& x);
  COREUTILITIES_API std::ostream& operator<<(std::ostream& os, const boost::optional<unsigned>& x);
  COREUTILITIES_API std::ostream& operator<<(std::ostream& os, const boost::optional<int>& x);
  COREUTILITIES_API std::ostream& operator<<(std::ostream& os, const boost::optional<std::string>& x);
}
