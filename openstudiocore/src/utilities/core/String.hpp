...
namespace openstudio {
  ...
  COREUTILITIES_API std::string toString(const std::string& s);

  /** char* to std::string. */
  COREUTILITIES_API std::string toString(const char* s);

  /** wstring to std::string. */
  COREUTILITIES_API std::string toString(const std::wstring& w);

  /** wchar_t* to std::string. */
  COREUTILITIES_API std::string toString(const wchar_t* w);

  /** QString to UTF-8 encoded std::string. */
  COREUTILITIES_API std::string toString(const QString& q);

  /** Double to std::string at full precision. */
  COREUTILITIES_API std::string toString(double v);

  /** QString to wstring. */
  COREUTILITIES_API std::wstring toWString(const QString& q);

  /** UTF-8 encoded std::string to QString. */
  COREUTILITIES_API QString toQString(const std::string& s);

  /** wstring to QString. */
  COREUTILITIES_API QString toQString(const std::wstring& w);
...
COREUTILITIES_API QTextStream& operator<<(QTextStream& qts, const std::string& s);
