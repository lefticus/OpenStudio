...
namespace openstudio {
   ...
   *  case. */
  COREUTILITIES_API std::string toCamelCase(const std::string& s);

  /** Make camel case then upcase the first letter. */
  COREUTILITIES_API std::string toUpperCamelCase(const std::string& s);

  /** Make camel case then downcase the first letter. */
  COREUTILITIES_API std::string toLowerCamelCase(const std::string& s);

  /** Convert IDD object and field names to something reasonable for computers. */
  COREUTILITIES_API std::string convertIddName(const std::string& s);

  /** Convert IDD object name to default name for IDF objects of this type. */
  COREUTILITIES_API std::string iddObjectNameToIdfObjectName(const std::string& s);
