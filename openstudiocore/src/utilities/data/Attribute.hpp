...
struct COREUTILITIES_API AttributeDescription {
  std::string name;
 ...
 */
class COREUTILITIES_API Attribute {
 public:
...
COREUTILITIES_API std::ostream& operator<<(std::ostream& os, const Attribute& attribute);

/** \relates Attribute */
// DLM: can this be a member of Attribute?
COREUTILITIES_API Attribute createAttributeFromVector(const std::string& name, std::vector<int> value);

/** \relates Attribute */
// DLM: can this be a member of Attribute?
COREUTILITIES_API Attribute createAttributeFromVector(const std::string& name, std::vector<double> value);

/** \relates Attribute */
// DLM: can this be a member of Attribute?
COREUTILITIES_API std::vector<int> getIntVectorFromAttribute(const Attribute& attribute);

/** \relates Attribute */
// DLM: can this be a member of Attribute?
COREUTILITIES_API std::vector<double> getDoubleVectorFromAttribute(const Attribute& attribute);

/** Returns true if candidate and description have matching names and types. \relates Attribute */
// DLM: can this be a member of Attribute?
COREUTILITIES_API bool isConsistent(const Attribute& candidate,const AttributeDescription& description);
...
// DLM: can this be a member of Attribute?
COREUTILITIES_API bool prepareForDisplay(Attribute& attribute, const AttributeDescription& description);

namespace detail {
  /** Places attribute's data in a QVariant for JSON serialization. */
  COREUTILITIES_API QVariant toVariant(const Attribute& attribute);

  /** Deserializes json variant to Attribute. */
  COREUTILITIES_API Attribute toAttribute(const QVariant& variant, const VersionString& version);
}
