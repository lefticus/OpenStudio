...
namespace detail {
  ...
  COREUTILITIES_API QVariant toVariant(const Tag& tag);

  /** Deserializes json variant to Tag. */
  COREUTILITIES_API Tag toTag(const QVariant& variant, const VersionString& version);
