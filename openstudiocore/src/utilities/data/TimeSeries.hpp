...
namespace openstudio{
  ...
  namespace detail{
    ...
    class COREUTILITIES_API TimeSeries_Impl
    {
      public:
   ...
   **/
  class COREUTILITIES_API TimeSeries
  {
    public:
      /** @name Constructors */
      //@{
  ...
  /** double * TimeSeries */
  COREUTILITIES_API TimeSeries operator*(double d,const TimeSeries& series);
  ...
  COREUTILITIES_API TimeSeries sum(const std::vector<TimeSeries>& timeSeriesVector);

  /** Returns boost::function pointer to sum(const std::vector<TimeSeries>&). */
  COREUTILITIES_API boost::function1<TimeSeries, const std::vector<TimeSeries>&> sumTimeSeriesFunctor();

  /** Evaluates functor(timeSeriesVector). For use in SWIG bindings. */
  COREUTILITIES_API TimeSeries evaluateTimeSeriesFromTimeSeriesVectorFunctor(
