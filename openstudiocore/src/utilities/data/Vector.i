...
COREUTILITIES_API boost::function1<double, const Vector &> sumVectorFunctor();

/** Returns boost::function pointer to maxiumum(const Vector&). */
COREUTILITIES_API boost::function1<double, const Vector &> maximumVectorFunctor();

/** Returns boost::function pointer to miniumum(const Vector&). */
COREUTILITIES_API boost::function1<double, const Vector &> minimumVectorFunctor();

/** Returns boost::function pointer to mean(const Vector&). */
COREUTILITIES_API boost::function1<double, const Vector &> meanVectorFunctor();

/** Returns boost::function pointer to variance(const Vector&). */
COREUTILITIES_API boost::function1<double, const Vector &> varianceVectorFunctor();

/** Returns boost::function pointer to stdDev(const Vector&). */
COREUTILITIES_API boost::function1<double, const Vector &> stdDevVectorFunctor();
