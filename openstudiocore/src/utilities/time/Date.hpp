...
namespace openstudio{
  ...
  COREUTILITIES_API DayOfWeek dayOfWeek(const std::string& day);
  ...
  COREUTILITIES_API MonthOfYear monthOfYear(const std::string& month);

  /// convert unsigned to MonthOfYear
  COREUTILITIES_API MonthOfYear monthOfYear(unsigned month);

  /// convert MonthOfYear to unsigned 
  COREUTILITIES_API unsigned month(MonthOfYear monthOfYear);
  ...
  COREUTILITIES_API NthDayOfWeekInMonth nthDayOfWeekInMonth(const std::string& nth);

  /// YearDescription describes a year with several optional parameters
  struct COREUTILITIES_API YearDescription{
  ...
  class COREUTILITIES_API Date
  {
  public:

    friend COREUTILITIES_API std::ostream& operator<<(std::ostream& os, const Date& date);
    friend COREUTILITIES_API std::ostream& operator<<(std::ostream& os, const DateTime& dateTime);
  ...
  COREUTILITIES_API std::ostream& operator<<(std::ostream& os, const Date& date);

  /// DateCompare compares two dates, returns true if lhs is less than rhs
  class COREUTILITIES_API DateCompare{
  public:
    /// operator()
  ...
  COREUTILITIES_API NthDayOfWeekInMonth nthDayOfWeekInMonth(const Date& date);
