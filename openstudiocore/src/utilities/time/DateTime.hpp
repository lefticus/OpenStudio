...
class COREUTILITIES_API DateTime {
 public:
...
COREUTILITIES_API std::ostream& operator<<(std::ostream& os, const DateTime& dateTime);

// conversion from QDateTime
COREUTILITIES_API DateTime toDateTime(const QDateTime &qdt);

// conversion to QDateTime
COREUTILITIES_API QDateTime toQDateTime(const DateTime& dt);
