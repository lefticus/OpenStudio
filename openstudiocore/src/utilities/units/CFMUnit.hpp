...
struct COREUTILITIES_API CFMExpnt {
 public:
  CFMExpnt(int ft=0,
           int min=0,
           int ton=0,
 ...
 */
class COREUTILITIES_API CFMUnit : public Unit {
 public:
...
/** \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMLength();
/** \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMTime();
/** \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMPower();
/** \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMTemperature();
/** \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMElectricCurrent();
/** \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMLuminousIntensity();
/** \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMAmountOfSubstance();
/** \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMAngle();
/** \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMSolidAngle();
/** \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMPeople();
/** \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMCycle();

/** Cubic feet per minute (cfm) = ft^3/min. \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMVolumetricFlowrate();
/** Lumen (lm) = cd*sr. \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMLuminousFlux();
/** Foot-candles (fc) = lm/ft^2 = cd*sr/ft^2. \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMIlluminance();
/** Rotations per minute (rpm) = cycles/min. \relates CFMUnit */
COREUTILITIES_API CFMUnit createCFMFrequency();
