...
struct COREUTILITIES_API GPDExpnt {
 public:
...
class COREUTILITIES_API GPDUnit : public Unit {
 public:
...
/** \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDPressure();
/** \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDLength();
/** \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDTime();
/** \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDTemperature();
/** \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDElectricCurrent();
/** \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDLuminousIntensity();
/** \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDAmountOfSubstance();
/** \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDAngle();
/** \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDSolidAngle();
/** \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDPeople();
/** relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDCycle();

// first order derived units

/** Gallons (gal). \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDVolume();
/** Gallons per day (gpd) = gal/day. \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDVolumetricFlowrate();
/** Lumen (lm) = cd*sr. \relates GPDUnit */
COREUTILITIES_API GPDUnit createGPDLuminousFlux();
