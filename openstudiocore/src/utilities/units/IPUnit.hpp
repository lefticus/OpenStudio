...
struct COREUTILITIES_API IPExpnt {
 public:
  IPExpnt(int lbm=0,
          int ft=0,
          int s=0,
...
class COREUTILITIES_API IPUnit : public Unit {
 public:
...
/** \relates IPUnit */
COREUTILITIES_API IPUnit createIPMass();
/** \relates IPUnit */
COREUTILITIES_API IPUnit createIPLength();
/** \relates IPUnit */
COREUTILITIES_API IPUnit createIPTime();
/** \relates IPUnit */
COREUTILITIES_API IPUnit createIPTemperature();
/** \relates IPUnit */
COREUTILITIES_API IPUnit createIPElectricCurrent();
/** \relates IPUnit */
COREUTILITIES_API IPUnit createIPLuminousIntensity();
/** \relates IPUnit */
COREUTILITIES_API IPUnit createIPAmountOfSubstance();
/** \relates IPUnit */
COREUTILITIES_API IPUnit createIPAngle();
/** \relates IPUnit */
COREUTILITIES_API IPUnit createIPSolidAngle();
/** \relates IPUnit */
COREUTILITIES_API IPUnit createIPPeople();
/** relates IPUnit */
COREUTILITIES_API IPUnit createIPCycle();

// first order derived units

/** lb_f is preferred over equivalent using lb_m. \relates IPUnit */
COREUTILITIES_API IPUnit createIPForce();
/** ft*lb_f is preferred over equivalent using lb_m. \relates IPUnit */
COREUTILITIES_API IPUnit createIPEnergy();
/** ft*lb_f/s is preferred over equivalent using lb_m. \relates IPUnit */
COREUTILITIES_API IPUnit createIPPower();
/** Coulomb (C) = s*A. \relates IPUnit */
COREUTILITIES_API IPUnit createIPElectricCharge();
/** Lumen (lm) = cd*sr. \relates IPUnit */
COREUTILITIES_API IPUnit createIPLuminousFlux();
/** Foot-candles (fc) = lm/ft^2 = cd*sr/ft^2. \relates IPUnit */
COREUTILITIES_API IPUnit createIPIlluminance();
...
COREUTILITIES_API IPUnit createIPFrequency();
