...
struct COREUTILITIES_API Misc1Expnt {
 public:
...
class COREUTILITIES_API Misc1Unit : public Unit {
 public:
...
/** \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1Pressure();
/** \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1Length();
/** \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1Time();
/** \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1Temperature();
/** \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1ElectricCurrent();
/** \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1LuminousIntensity();
/** \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1AmountOfSubstance();
/** \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1Angle();
/** \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1SolidAngle();
/** \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1People();
/** relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1Cycle();

// first order derived units

/** Liters (L). \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1Volume();
/** Lumen (lm) = cd*sr. \relates Misc1Unit */
COREUTILITIES_API Misc1Unit createMisc1LuminousFlux();
