...
class COREUTILITIES_API OSQuantityVector {
 public:
...
COREUTILITIES_API OSQuantityVector operator-(const OSQuantityVector& rVector);

/** \relates OSQuantityVector */
COREUTILITIES_API OSQuantityVector operator+(const OSQuantityVector& lVector,
...
/** \relates OSQuantityVector */
COREUTILITIES_API OSQuantityVector operator+(const Quantity& lQuantity,
                                         const OSQuantityVector& rVector);
...
/** \relates OSQuantityVector */                                         
COREUTILITIES_API OSQuantityVector operator*(const OSQuantityVector& lVector, double d);
...
/** \relates OSQuantityVector */                                         
COREUTILITIES_API OSQuantityVector operator*(double d,
                                         const OSQuantityVector& rVector);
...
/** \relates OSQuantityVector */
COREUTILITIES_API Quantity dot(OSQuantityVector lVector, const OSQuantityVector& rVector);

/** \relates OSQuantityVector */
COREUTILITIES_API bool operator==(const OSQuantityVector& lVector,const OSQuantityVector& rVector);
