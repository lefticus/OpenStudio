...
class COREUTILITIES_API Quantity {
 public:
  /** @name Constructors */
  //@{
  ...
  friend COREUTILITIES_API std::ostream& operator<<(std::ostream& os,const Quantity& q);
...
/** \relates Quantity */
COREUTILITIES_API std::ostream& operator<<(std::ostream& os,const Quantity& q);
...
/** Negate a Quantity. */
COREUTILITIES_API Quantity operator-(const Quantity& rQuantity);
/** Add Quantities. Used with base class Quantities and mixed Quantity types. */
COREUTILITIES_API Quantity operator+(const Quantity& lQuantity,const Quantity& rQuantity);
...
COREUTILITIES_API Quantity pow(const Quantity& rQuantity,int expNum,int expDenom=1);

/** Multiply a Quantity by a double. */
COREUTILITIES_API Quantity operator*(const Quantity& lQuantity,double d);
/** Multiply a Quantity by a double. */
COREUTILITIES_API Quantity operator*(double d,const Quantity& rQuantity);
/** Divide a Quantity by a double. */
COREUTILITIES_API Quantity operator/(const Quantity& lQuantity,double d);
/** Divide a double by a Quantity. */
COREUTILITIES_API Quantity operator/(double d,const Quantity& rQuantity);

COREUTILITIES_API bool operator==(const Quantity& lQuantity,const Quantity& rQuantity);
