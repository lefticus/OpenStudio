...
class COREUTILITIES_API QuantityConverterSingleton {
...
COREUTILITIES_API boost::optional<double> convert(double original, const std::string& originalUnits, const std::string& finalUnits);

/** Non-member function to simplify interface for users. \relates QuantityConverterSingleton */
COREUTILITIES_API boost::optional<Quantity> convert(const Quantity& original, UnitSystem sys);
...
COREUTILITIES_API OSQuantityVector convert(const OSQuantityVector& original, UnitSystem sys);

/** Non-member function to simplify interface for users. \relates QuantityConverterSingleton */
COREUTILITIES_API boost::optional<Quantity> convert(const Quantity& original, const Unit& targetUnits);

/** Non-member function that uses just two calls to QuantityConverter to convert an entire 
 *  OSQuantityVector. \relates QuantityConverterSingleton \relates OSQuantityVector */
COREUTILITIES_API OSQuantityVector convert(const OSQuantityVector& original, const Unit& targetUnits);
