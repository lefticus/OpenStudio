...
class COREUTILITIES_API QuantityFactorySingleton {
...
COREUTILITIES_API boost::optional<Quantity> createQuantity(const std::string& quantityString);

COREUTILITIES_API boost::optional<Quantity> createQuantity(const std::string& quantityString, UnitSystem system);

/** Creates a general Quantity object corresponding to value * unitString. */
COREUTILITIES_API boost::optional<Quantity> createQuantity(double value, const std::string& unitString);

COREUTILITIES_API boost::optional<Quantity> createQuantity(double value,
