...
namespace openstudio{
  ...
  struct COREUTILITIES_API Scale {
  ...
  COREUTILITIES_API std::ostream& operator<<(std::ostream& os,const Scale& s);

  /** Equality operator for Scales. Checks exponent and abbreviation. */
  COREUTILITIES_API bool operator==(const Scale& firstScale,const Scale& secondScale);
  ...
  COREUTILITIES_API const Scale& notDefined();

  /** Static constant defining SI prefix for 10^24. */
  COREUTILITIES_API const Scale& yotta();

  /** Static constant defining SI prefix for 10^21. */
  COREUTILITIES_API const Scale& zetta();

  /** Static constant defining SI prefix for 10^18. */
  COREUTILITIES_API const Scale& exa();

  /** Static constant defining SI prefix for 10^15. */
  COREUTILITIES_API const Scale& peta();

  /** Static constant defining SI prefix for 10^12. */
  COREUTILITIES_API const Scale& tera();

  /** Static constant defining SI prefix for 10^9. */
  COREUTILITIES_API const Scale& giga();

  /** Static constant defining SI prefix for 10^6. */
  COREUTILITIES_API const Scale& mega();

  /** Static constant defining SI prefix for 10^3. */
  COREUTILITIES_API const Scale& kilo();

  /** Static constant defining no scale (1.0). */
  COREUTILITIES_API const Scale& one();

  /** Static constant defining SI prefix for 10^{-2} */
  COREUTILITIES_API const Scale& centi();

  /** Static constant defining SI prefix for 10^{-3} */
  COREUTILITIES_API const Scale& milli();

  /** Static constant defining SI prefix for 10^{-6} */
  COREUTILITIES_API const Scale& micro();

  /** Static constant defining SI prefix for 10^{-9} */
  COREUTILITIES_API const Scale& nano();

  /** Static constant defining SI prefix for 10^{-12} */
  COREUTILITIES_API const Scale& pico();

  /** Static constant defining SI prefix for 10^{-15} */
  COREUTILITIES_API const Scale& femto();

  /** Static constant defining SI prefix for 10^{-18) */
  COREUTILITIES_API const Scale& atto();

  /** Static constant defining SI prefix for 10^{-21} */
  COREUTILITIES_API const Scale& zepto();

  /** Static constant defining SI prefix for 10^{-24} */
  COREUTILITIES_API const Scale& yocto();
