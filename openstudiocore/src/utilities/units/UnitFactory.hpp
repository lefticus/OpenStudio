 ...
 *  create a unit. */
class COREUTILITIES_API UnitFactorySingleton {
 ...
 *  \relates UnitFactorySingleton */
COREUTILITIES_API UnitSystem getSystem(const std::string& unitString);

/** Returns true if unitString can be created as a unit in system. \relates UnitFactorySingleton */
COREUTILITIES_API bool isInSystem(const std::string& unitString, UnitSystem system);

/** Returns true if any of unitString's baseUnits are registered in the factory.
 *  \relates UnitFactorySingleton */
COREUTILITIES_API bool containsRegisteredBaseUnit(const std::string& unitString); 
...
COREUTILITIES_API std::string extractUnitString(const std::string& text);
...
COREUTILITIES_API std::string convertToStandardForm(const std::string& unitString);

/** Replaces unitString in text, using same finder algorithm as extractUnitString.
 *  \relates UnitFactorySingleton */
COREUTILITIES_API std::string replaceUnitString(const std::string& text,
                                            const std::string& newUnitString);

/** Returns true if unitString can be turned into a Unit. \relates UnitFactorySingleton */
COREUTILITIES_API bool isUnitString(const std::string& unitString);

/** Returns a Unit of the type that corresponds to system. \relates UnitFactorySingleton */
COREUTILITIES_API Unit createDimensionlessUnit(UnitSystem system);
 ...
 *  \relates UnitFactorySingleton */
COREUTILITIES_API boost::optional<Unit> createUnit(const std::string& unitString,UnitSystem system);
