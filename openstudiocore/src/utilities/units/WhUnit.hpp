...
struct COREUTILITIES_API WhExpnt {
 public:
  WhExpnt(int W=0,
          int h=0,
          int m=0,
...
class COREUTILITIES_API WhUnit : public Unit {
 public:
...
/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhPower();
/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhTime();
/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhLength();
/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhTemperature();
/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhElectricCurrent();
/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhLuminousIntensity();
/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhAmountOfSubstance();
/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhAngle();
/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhSolidAngle();
/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhPeople();
/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhCycle();

/** \relates WhUnit */
COREUTILITIES_API WhUnit createWhEnergy();
/** Volt (V) = W/A. \relates WhUnit */
COREUTILITIES_API WhUnit createWhElectricalPotential();
/** Ohm (ohm) = V/A = W/A^2. \relates WhUnit */
COREUTILITIES_API WhUnit createWhElectricResistance();
/** Lumen (lm) = cd*sr. \relates WhUnit */
COREUTILITIES_API WhUnit createWhLuminousFlux();
/** Lux (lux or lx) = lm/m^2 = cd*sr/m^2. \relates WhUnit */
COREUTILITIES_API WhUnit createWhIlluminance();
